...
The frst line contains 0 < n ≤ 100, the number of freckles on Dick’s back. For each freckle, a line
...
public class Freckles {
     ...
     * @param prev
     */
    public void prime(int graph, int source, int[] prev) {

    }

    public double caculateSumDist(int[] prev) {
